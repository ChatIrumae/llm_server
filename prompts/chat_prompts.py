...
class ChatPrompts:
    ...
    @staticmethod
    def build_rag_prompt(message: str, chroma_results: List[Dict[str, Any]], user_info: Dict[str, Any] = None) -> str:
        """
        RAG 기반 답변 생성을 위한 프롬프트
        """
...
- 위치나 장소에 대한 질문인 경우 구체적인 위치 정보를 포함
"""
